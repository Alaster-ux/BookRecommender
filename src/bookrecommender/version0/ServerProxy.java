...
/**
 * ServerProxy gestisce la connessione tra client e server.
 * Permette di inviare comandi al server e ricevere risposte,
 * mascherando la complessità della comunicazione.
 */
public class ServerProxy {
	...
	boolean connected = false;
	 ...
	 /** 
     * Costruttore: stabilisce la connessione con il server.
     */	
	public ServerProxy() {
		try {
	 ...
	 /** @return true se la connessione con il server è attiva */
     ...
     * @return codice di esito (-4 = errore generico o campi vuoti, -1/-2/-3 = errori specifici, 0 = successo)
     */
     ...
     * @return userID se login riuscito, null altrimenti
     */
     ...
     * @return lista di libri trovati o null in caso di errore
     */
	...
	/** Recupera una libreria tramite ID */
	...
	@SuppressWarnings("finally")
	/** Aggiunge un commento a un libro */
	...
	public Libreria registraLibreria(String userID, String nomeLibreria) {
		try {
	...
	/** Aggiunge un suggerimento libro */
	@SuppressWarnings("finally")
	...
	/** Restituisce il prospetto completo di un libro */
	@SuppressWarnings("finally")
